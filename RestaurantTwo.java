...
public static void afterSend(){
      ...
      output.append("\nRevenue for Cheeseburgers: $" + entreeOneRevenue(entreeOnePrice, entreeOneSold));
      output.append("\nRevenue for BBQ Bacon Burgers: $" + entreeTwoRevenue(entreeTwoPrice, entreeTwoSold));
      output.append("\nRevenue for Sapo Specials: $" + entreeThreeRevenue(entreeThreePrice, entreeThreeSold));
      output.append("\nRevenue for Frog Tails: $" + sideOneRevenue(sideOnePrice, sideOneSold));
      output.append("\nRevenue for Roasted Veggies: $" + sideTwoRevenue(sideTwoPrice, sideTwoSold));
