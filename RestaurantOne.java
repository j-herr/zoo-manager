...
public class RestaurantOne {
   ...
   static String restaurantName = "The Hot Dog Pound";
   static String entreeOne = "Classic Dog";static String entreeTwo = "Chicago Dog";
   static String entreeThree = "The Big Dog";static String sideOne = "Fries";static String sideTwo = "Dog Collars"; 
   static int backHouseWorkers = 0;static  int frontHouseWorkers = 0;static  int frontHouseWage = 0;static  int backHouseWage = 0;static  int managers = 0; int managerWage = 0;
   static int entreeOnePrice = 9;static  int entreeTwoPrice = 10;static  int entreeThreePrice = 12;static  int sideOnePrice = 3;static  int sideTwoPrice = 4;
   ...
   static int entOneRev;static int entTwoRev;static int entThreeRev;static int sideOneRev;static int sideTwoRev;
   static int totalFrontWage = 0; static int totalBackWage = 0; static int totalManagerWage = 0;  
   //Initialization for revenue variables
...
public static void employeeScreen() {
   ...
   public static int getEntOne() { return entOneRev; } 
   public static int getEntTwo() { return entTwoRev; }
   public static int getEntThree() { return entThreeRev; }
   public static int getSideOne() { return sideOneRev; }
   public static int getSideTwo() { return sideTwoRev; }
   public static int getBackWage() { return totalBackWage; }
   public static int getFrontWage() { return totalFrontWage; }
   public static int getManagerWage() { return totalManagerWage; }

public static void afterSend(){
      compare = 1;
      
      entOneRev = entreeOneRevenue(entreeOnePrice, entreeOneSold);
      entTwoRev = entreeTwoRevenue(entreeTwoPrice, entreeTwoSold);
      entThreeRev = entreeThreeRevenue(entreeThreePrice, entreeThreeSold);
      sideOneRev = sideOneRevenue(sideOnePrice, sideOneSold);
      sideTwoRev = sideTwoRevenue(sideTwoPrice, sideTwoSold);
      totalFrontWage = frontEmployeeWages(9, frontHouseWorkers);
      totalBackWage = backEmployeeWages(15, backHouseWorkers);
      totalManagerWage = managerWages(50, managers);
      ...
      output.append("\n\nBack of House Workers total wage: $" + backEmployeeWages(15, backHouseWorkers));
      output.append("\nFront of House Workers total wage: $" + frontEmployeeWages(9, frontHouseWorkers));
      output.append("\nManagers total wage: $" + managerWages(50, managers));
      sentFrame.setVisible(true);
         ...
         send.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               if(RestaurantTwo.testCompare() == 0) {
                     ChoosingRestaurant.rest2Pass();
                     sentFrame.dispose();
               }
               else if(RestaurantOne.testCompare() == 1 && RestaurantTwo.testCompare() == 1) {
                  ZooUI.main(null);
                  sentFrame.dispose();
               }
               else{
...
/*int totalBackWage = backEmployeeWages(backHouseWage, backHouseWorkers);
  ...
  /* public void testingMain() {
   ...
   backHouseWorkers = 10;frontHouseWorkers = 8;frontHouseWage = 10;backHouseWage = 15;managers = 2;managerWage = 50; 
   entreeOneSold = 70;entreeTwoSold = 63;entreeThreeSold = 84;sideOneSold = 120;sideTwoSold = 98;
